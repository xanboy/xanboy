...
## Engineering posture (how I work)

- **Security boundaries by default:** request validation, auth scopes, secret handling, least privilege
- **Reliability as a feature:** idempotency keys, outbox/queue patterns, backoff, dead-lettering, safe retries
- **Operational clarity:** structured logs, traceable events, minimal “unknown unknowns”
- **Data correctness:** consistent identifiers, currency/amount discipline, reversible adjustments for refunds/cancels
...
<p align="center">
  <img
    alt="Tech Stack"
    src="https://skillicons.dev/icons?theme=dark&perline=14&i=nodejs,express,postgres,sqlite,docker,gcp,github,git,githubactions,postman,linux,python,tensorflow,opencv,java,js,html,css,react,nextjs,tailwind,terraform"
  />
</p>

<p align="center">
  <sub>
    Also comfortable with: SQL (analytics) · Cloud Run / Cloud SQL patterns · IAM/service identity · secrets management · pytest/selenium foundations · Jupyter/Pandas/NumPy/Matplotlib
  </sub>
</p>
